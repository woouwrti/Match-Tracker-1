const TeamIcon = ({ width = 48, height = 49, fillColor = "none" }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_68_8388)"
      />
      <path
        ...
        stroke="url(#paint1_linear_68_8388)"
        stroke-width="2"
      />
      <rect
        x="14"
        ...
        height="2"
        rx="0.4"
        fill="url(#paint2_linear_68_8388)"
      />
      <path
        ...
        fill="url(#paint3_linear_68_8388)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_68_8388"
          x1="24"
          y1="0.5"
          x2="24"
          y2="48.5"
